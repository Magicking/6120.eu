...
\usepackage[a4paper,left=10mm,width=170mm,top=7mm,bottom=7mm,includeheadfoot]{geometry}
\usepackage{booktabs}
...
setResolution(width, height) & Set canvas size & setResolution(1920,1080) \\
